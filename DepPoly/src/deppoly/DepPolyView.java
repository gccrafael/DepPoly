...
public class DepPolyView extends FrameView {    
    ...
    public DepPolyView(SingleFrameApplication app) {
        ...
        URL url = ClassLoader.getSystemResource("deppoly/about.png");
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            ...
            aboutBox = new DepPolytAboutBox(mainFrame);
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtxtName, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jtxtCost, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(80, 80, 80)
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(mainPanelLayout.createSequentialGroup()
    ...
    private void jbtnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCalcActionPerformed
        ...
        if (jradStraight.isSelected()) {
            asset = new AssetSL(jtxtName.getText(), cost, salvage, life);
        }
        else if (jrad15DL.isSelected()) {
            asset = new Asset15DL(jtxtName.getText(), cost,salvage,life);    
        }
        else {
            asset = new AssetDDL(jtxtName.getText(), cost, salvage, life);
        ...
        for (int i = 0; i < life; i++)
        {
            ...
            jTable1.setValueAt(curr.format(asset.getBegBal(i)), i, 1);
            jTable1.setValueAt(curr.format(asset.getEndBal(i)), i, 3);                        
        }    
